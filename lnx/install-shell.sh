...
curl -fLo /usr/share/fonts/opentype/Fura\ Code\ Regular\ Nerd\ Complete.otf https://github.com/ryanoasis/nerd-fonts/blob/master/patched-fonts/FiraCode/Regular/complete/Fura%20Code%20Regular%20Nerd%20Font%20Complete.otf
sudo fc-cache -fv
...
tar xzvf ~/bin/ripgrep.tar.gz ~/bin
mv ~/bin/ripgrep/rg ~/bin
rm -r ripgrep*
