...
set git_town_commands hack kill new-pull-request prune-branches rename-branch repo ship sync 
...
complete --command git --long-option 'abort' --description 'Abort a previous command that resulted in a conflict' --no-files
complete --command git --long-option 'continue' --description 'Continue a previous command that resulted in a conflict' --no-files
complete --command git --long-option 'undo' --description 'Undo a previous command' --no-files
