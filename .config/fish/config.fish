...
abbr -a gl "git log --color --decorate --graph --all --oneline | less"
...
abbr -a gspsh "git push origin --recurse-submodules=on-demand"
...
abbr -a pshm "git push origin HEAD:$GIT_MAIN_LOCAL"
