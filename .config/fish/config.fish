...
abbr -a grbso "git rebase -s recursive -X ours --autostash"
abbr -a grbst "git rebase -s recursive -X theirs --autostash"
...
abbr -a gwa "cd (git rev-parse --show-toplevel) && git worktree add -f"
